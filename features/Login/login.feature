Feature: Verify demio login feature
    ...
    Scenario: Check user is able to click on "Forgot your password?" link
    ...
    Scenario Outline: Check "Forgot your password?" functionality
        ...
        Examples:
            | email                   | informativeText                                                                                  |
            | tester.desk24@gmail.com | Check your inbox. We're sending you an email with instructions about how to reset your password. |
