...
Feature: Verify demio sigh up for a business feature
  As a User i want to check business sign up feature of demio web app

  Background:
    Given the user should open the business URL


  Scenario Outline: Check User is able to create a account with Business plan.
    ...
    Examples:
      ...
      | Auto      | TestT1   | tester.desk24+t19@gmail.com | desk tester   | 4000056655665556 | 02          | 2022       | 215     | Testing123 | Testing123      | A1 company  | Generate new leads | Google Search   |