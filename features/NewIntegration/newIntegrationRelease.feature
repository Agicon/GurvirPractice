Feature: Verify New room page features
  ...
  Scenario Outline: Check if user is able to enable "Ontraport" integration
    ...
    Examples:
      ...
      | admin | A         | 11:00 pm   | OfficeAutopilot / Ontraport | releaseLoginUrl | Last Name | Website | Phone Number | Company | Text            | ZipCode      | TextField | Text Area           | Add text in text area | Dropdown            | Dropdown      | New user | Old User | Checkbox            | Checkbox     | Textuser | Demio: Register | Add Tag  | Demio: Attend | Add Tag      | Demio: No Show | Last Note      | IP Address    | Office Phone | Title           | Number                      | None                      | URL                      | Refer          | Facebook          | Twitter          | Company       | Fax            | Address        | City           | Zip Code      | Referring Page | Facebook       | Twitter       | user | tester   | www.demio.com | 9027365417 | 785964  | manager | www.fb.com | twitter200 | testing | i am new user | "success": 1, | Join Link     |
  ...
  Scenario Outline: Check if user is able to enable "Keap" integration
    ...
    Examples:
      ...
      | admin | B         | 11:00 pm   | Keap        | releaseLoginUrl | Last Name | Website | Phone Number | Company | Text            | ZipCode      | TextField | Text Area           | Add text in text area | Dropdown            | Dropdown      | New user | Old User | Checkbox            | Checkbox     | Textuser | Add Tag  | Qa Registrants | Add Tag      | Qa Registrants | Last Name      | Website       | Phone1 Number | Field 2         | Number                      | None                      | URL                      | Refer          | Facebook          | Twitter          | QACOMPANY     | Field 3        | Drodown        | Checkbox       | Address Zip Code | Middle Name | Email 2        | Phone         | user | tester   | www.demio.com | 9027365417 | 785964  | Email 3 | www.fb.com | twitter200 | testing | i am new user | "success": 1, | DemioJoinLink | Qa Registrants | Registered  | Missed       | Attendees      |
...
Scenario Outline: Check if user is able to enable "Salesforce Pardot" integration
    ...
    Examples:
      ...
      | admin | G         | 11:00 pm   | Pardot      | releaseLoginUrl | Last Name | Website | Phone Number | Company | Text            | ZipCode      | TextField | Text Area           | Add text in text area | Dropdown            | Dropdown      | New user | Old User | Checkbox            | Checkbox     | Textuser | Add to List | Add to List | QA ATTENDED     | Add to List  | QA NOSHOW   | QA LASTNAME    | QA WEBSITE    | QA PHONE    | QA TEXTFIELD       | Number                      | None                      | URL                      | Refer          | Facebook          | Twitter          | QA COMPANY | QA TEXTAREA    | QA DROPDOWN    | QA CHECKBOX    | QA ZIPCODE    | QA REFER    | QA FACEBOOK    | QA TWITTER    | user | tester   | www.demio.com | +19027365417 | 785964  | manager | www.fb.com | twitter200 | testing | i am new user | "success": 1, | QA JOINLINK   |QA REGISTRANTS |
